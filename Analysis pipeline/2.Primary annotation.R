...
pdf('2.Cluster/Annotate/cellType.marker.heatmap.pdf',width = 12,height = 22)
...
pdf("2.Cluster/Annotate/group.cellratio.pdf", height = 10, width = 4)
...
pdf('2.Cluster/Annotate/dimplot.sample.pdf')
DimPlot(data.merge,group.by = 'major_celltype',reduction = 'umap',split.by = 'sample',cols = Palettes[['mycols_8']],label = F,ncol = 2)
DimPlot(data.merge,group.by = 'major_celltype',reduction = 'tsne',split.by = 'sample',cols = Palettes[['mycols_8']],label = F,ncol = 2)
dev.off()
